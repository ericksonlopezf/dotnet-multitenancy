...
public static partial class PostgreSqlOrganizationRlsExtensions
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Stryker disable once logical : Guard clause for valid resolved tenant context
        ...
        // 2. Company Isolation
        // Stryker disable once logical : Company context presence check
        ...
        // Stryker disable conditional, string : String boolean representation
        // Stryker disable once boolean : ConfigureAwait optimization
        await connection.ExecuteAsync(
            new CommandDefinition(
        ...
        // Stryker disable once equality : Branch count check
    ...
    {
        ArgumentNullException.ThrowIfNull(connection);
        // Stryker disable once statement : Guard clause defensively duplicated by SetEnterpriseOrganizationRlsContextAsync
        ArgumentNullException.ThrowIfNull(context);
