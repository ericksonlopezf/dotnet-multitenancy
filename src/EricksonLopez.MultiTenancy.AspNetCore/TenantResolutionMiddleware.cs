...
public sealed partial class TenantResolutionMiddleware
{
    ...
    // Stryker disable all, String : OpenTelemetry metrics instrumentation
        ...
        ITenantContextAccessor accessor)
    {
        ...
        // Stryker disable Logical, NullCoalescing, String : Principal tenant claim validation and fallback hierarchy
            ...
            !resolvedId.IsEmpty)
        {
            ...
            // Stryker restore Logical, NullCoalescing, String
        ...
        if (!resolvedId.IsEmpty)
        {
            ...
            else
            {
                ...
                {
                    // Stryker disable once statement, NullCoalescing, String : Defensive logging of store miss
