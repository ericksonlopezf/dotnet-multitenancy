...
/// <summary>
/// Represents a <see cref="DbTransaction"/> decorator that automatically resets Oracle VPD / client identifier context upon transaction disposal,
/// ensuring that pooled connections returned to ADO.NET do not retain tenant context.
/// </summary>
internal sealed class OracleTenantSessionTransaction : DbTransaction
{
    ...
    public OracleTenantSessionTransaction(
