...
public static class CachedTenantStoreExtensions
{
        ...
        where TTenant : class, ITenantInfo
    {
        ...
        // Stryker disable once equality : Optional registration of typed lookup store decorator
        ...
        // Stryker disable once equality : Optional registration of untyped lookup store decorator
