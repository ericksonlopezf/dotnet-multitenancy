...
/// <summary>
/// Represents a <see cref="DbTransaction"/> decorator that automatically resets MySQL tenant session variables upon transaction disposal,
/// ensuring that pooled connections returned to ADO.NET do not retain tenant context.
/// </summary>
internal sealed class MySqlTenantSessionTransaction : DbTransaction
{
    ...
    public MySqlTenantSessionTransaction(
